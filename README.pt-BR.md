...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&pause=1000&color=00FF00&center=true&vCenter=true&width=600&lines=Gabriel+Lopes+%7C+maralto-js;Dev+back-end+%7C+Java+21;Minecraft+Plugins+%7C+Java+Dev" alt="Typing SVG" />
...
[![GitHub](https://img.shields.io/badge/GitHub-maralto--js-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/maralto-js)
...
> Engine de combate e XP baseada em nível para servidores RPG · Paper 1.21+ · v2.0.0 · **MIT**

- 🆓 **Grátis e open source:** sem license key, sem paywall, sem telemetria
- 🎖️ **XP por nível:** razão mob/player com clamp, anti-farm progressivo e penalidade de overlevel
- ⚔️ **Dano escalável:** melee e ranged com fórmulas independentes e clamp configurável
- 🏆 **Ranking de jogadores:** placar all-time de kills e XP + placeholders para scoreboard
- 🔌 **Plug-and-play:** MMOCore · MythicMobs · LevelledMobs · PlaceholderAPI — todos **opcionais**
- 🌍 **3 idiomas:** Inglês, Português e Espanhol
- 🧩 **API pública:** evento `CombatXpGainEvent` cancelável para outros plugins
